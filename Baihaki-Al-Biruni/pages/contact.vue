    ...
    <section>
      <div class="font-sans antialiased leading-normal tracking-wider bg-cover">
        ...
        >
          ...
          <div
            id="profile"
            class="w-full lg:w-12/12 rounded-lg lg:rounded-l-lg lg:rounded-r-none mx-6 lg:mx-0"
          >
            <div
            ...
            >
              ...
              <a
                target="_blank"
                class="link"
                href="https://github.com/BaihakiTanjung"
              ...
              <a
                target="_blank"
                class="link"
                href="https://www.instagram.com/byhkab_/?hl=id"
              ...
              <a
                target="_blank"
                class="link"
                href="https://www.youtube.com/channel/UCCzpBZ5uM9OMQlJy7m-LuWA"
